...
useEffect(()=>{
  ...
  return (
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 dark:bg-slate-900 dark:text-white ${
      sticky?"sticky-navbar shadow-md bg-base-100 duration-300 transition-all ease-in-out z-50 dark:bg-slate-800 dark:text-white"
      : ""
    }`}>
    <div className="navbar">
      <div className="navbar-start">
        ...
        <a className="text-2xl font-bold cursor-pointer">E-learn</a>
      </div>
